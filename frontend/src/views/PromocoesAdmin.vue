    ...
    <div>
        ...
        <Dialog v-model:visible="productDialog" :style="{width: '450px'}" header="Product Details" :modal="true" class="p-fluid">
            <div class="field">
                ...
                <small class="p-error" v-if="submitted && !product.name">O nome é obrigatório.</small>
            </div>
            ...
            <div class="field">
                ...
                <Textarea id="description" v-model="product.description" required="true" rows="3" style="width: 100%" />
            </div>
